      ...
      <section className="z-40 relative bg-slate-900 text-base text-white font-light pt-32">
        ...
        <Link className='flex items-center justify-center flex-col'
                ...
                to='/cart'>
                  ...
                  <box-icon id='fabcart' name='cart' type='solid' color='#ffffff' class='mt-[15px]'></box-icon>
        </Link>
        </button>
        <section className="text-gray-600 body-font overflow-hidden">
          <div className="container px-5 py-24 mx-auto">

            {
              ...
              <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={val.img}/>
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                    <div className="flex">
                      <span className="mr-3">Color: {val.color}</span>
                      </div>
                    <div className="flex ml-6 items-center">
                      <span className="mr-3">Size</span>
                      <div className="text-black relative">
                        <select id={val.id} className="font-medium rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
                          {val.size.map((v,n)=>{
                            return(
                  ...
                  <div className="flex">
                    ...
                    <button id={`btn_${val.id}`} className="flex ml-auto text-white border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded bg-blue-100" onClick={()=>{
