        ...
        <div>
            <section className="bg-slate-900 px-3 py-[270px] lg:py-32 flex flex-col items-center transform -translate-y-[140px] lg:translate-y-[40px] ">
                ...
                <div class="text-white w-4/5 sm:w-auto flex mx-auto mt-10 mb-10">
                    ...
                    <p id='accostep2' class="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium bg-gray-100 inline-flex items-center leading-none border-indigo-500 text-indigo-500 tracking-wider rounded-t">
                        STEP 2
                    </p>
                    <p id='accostep3' class="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium bg-gray-100 inline-flex items-center leading-none border-indigo-500 text-indigo-500 tracking-wider rounded-t">
                        STEP 3
                    </p>
                </div>
                <div className='accomodform text-white bg-richblack-800 border-[1px] border-richblack-200' id='noofpersonforacco'>
                    <span className='text-sm sm:text-xl'>*CHARGES: ₹200 per person per day<br />*Fill Details of Participants only. Details of Guardians will be taken later.</span>
                    <div className="mt-4 roomdetails">
                        ...
                        <div className="noofpersons flex-col sm:flex-row items-center flex justify-around">
                            <div className="mb-4 sm:mb-1 text-center">
                                <span className='checktext block text-xl mb-2'>MALE<sup>#</sup></span>
                            ...
                            <div className="mb-4 sm:mb-1 text-center">
                                <span className='checktext block text-xl mb-2'>FEMALE<sup>#</sup></span>
                                <div class="flex text-richblack-50">
                                    <button class="flex ml-auto bg-blue-200 border-0 py-2 px-2 focus:outline-none hover:bg-blue-600 rounded" onClick={() => {
