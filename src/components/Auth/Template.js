...
const Template = ({ title, description1, description2, image, formType }) => {
  ...
  return (
    <div className="font-inter lg:pt-20">
      {loading ? (
        ...
        <div className="w-11/12 max-w-maxContent mx-auto flex flex-col items-center justify-center lg:flex-row gap-x-[140px]">
          ...
          <div className="lg:w-[558px] h-[504px]">
            <img src={frameImg} alt="" className="transform -translate-y-[50px]" />

            <img src={image} alt="" className="transform -translate-y-[640px] -translate-x-[25px]" />
          </div>
        </div>
      )}
    </div>
