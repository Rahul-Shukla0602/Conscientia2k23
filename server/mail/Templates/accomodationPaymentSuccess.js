exports.accomodationPaymentSuccess = (name, amount, orderId, paymentId) => {
    return `<!DOCTYPE html>
      <html>
      ...
      <body>
          <div class="container">
             <a href="https://www.conscientia.co.in/"><img class="logo" src="https://res.cloudinary.com/dwdwnfcnx/image/upload/v1690132004/Conscientiateam/g85golybsz6bfzowafyf.png"
              ...
              <div class="message">Payment Successful for Accomodation</div>
              <div class="body">
                  <p>Dear ${name},</p>
                  <span class='highlight'>Payment of ₹${amount} is Successful</span>
                  <p>Thanks for Registration. You will get another email regarding this.</p>.
                  <br>
